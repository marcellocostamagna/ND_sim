...
def choose_eig_sign(eigenvectors, transformed_data):
    for i in range(eigenvectors.shape[1]):
        ...
        while True:
            ...
            mask_max = np.isclose(np.abs(transformed_data[remaining_indices, i]), max_abs_coordinate)
        ...
        if transformed_data[max_indices[0], i] < 0:
            eigenvectors[:, i] *= -1
